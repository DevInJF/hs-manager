...
<div class="panel panel-default " id="ag-login">
    <div class="panel-body">
        ...
        <form id="loginForm" class="form-horizontal" role="form" action="<?php echo $linkloginonly; ?>" method="post" name="loginform">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control input-lg" id="inputLogin" name="username"
                           placeholder="Login" autofocus required onkeyup="document.loginform.password.value = this.value">
                </div>
            </div>
